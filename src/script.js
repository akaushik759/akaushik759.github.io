    ...
    function changeColor(buttonName)
    {
        ...
        if(!choiceCodes.includes(buttonName))
        {
        ...
        {
            document.getElementById(buttonName).style.backgroundColor="#1c60ff";
            var index=choiceCodes.indexOf(buttonName);
            if(index>-1)
            {
                choiceCodes.splice(index,1);
            }
        }
    }
